...
birth_rate = 1  * 10 * 60 * 24 * 365
death_rate = 0.5 * birth_rate
immigration_rate = 6/40 * birth_rate

three_year_population= current_population + 3 * (birth_rate - death_rate + immigration_rate) 
print(three_year_population)
